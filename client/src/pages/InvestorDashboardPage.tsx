...
import { ListFilter, TrendingUp, MessageSquare, User, Settings, Bell, ChevronRight, Search } from 'lucide-react';
        ...
        <div className="md:flex md:items-center md:justify-between mb-8">
          ...
          <div className="mt-4 flex md:mt-0 md:ml-4">
            <Link to="/ranked-ideas">
              <Button variant="outline" leftIcon={<TrendingUp className="h-5 w-5" />} className="mr-3">
                View All Ranked Ideas
              </Button>
            </Link>
            <Button leftIcon={<ListFilter className="h-5 w-5" />} onClick={toggleFilters}>
              Filters
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
              ...
              <div className="border-t border-gray-200">
                <nav className="flex-1">
                  ...
                  <a href="#" className="flex items-center py-3 px-6 text-gray-600 hover:bg-gray-50 transition-colors">
                    ...
                    <span className="ml-auto bg-primary-100 text-primary-600 py-0.5 px-2 rounded-full text-xs font-medium">5</span>
                  </a>
                  <a href="#" className="flex items-center py-3 px-6 text-gray-600 hover:bg-gray-50 transition-colors">
                    <Bell className="h-5 w-5 mr-3" />
                    <span className="text-sm font-medium">Notifications</span>
                    <span className="ml-auto bg-primary-100 text-primary-600 py-0.5 px-2 rounded-full text-xs font-medium">2</span>
                  </a>
                  <a href="#" className="flex items-center py-3 px-6 text-gray-600 hover:bg-gray-50 transition-colors">
            ...
            <div className="mt-6 bg-white shadow rounded-lg overflow-hidden">
              <div className="p-6">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Your Investment Preferences</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500">Preferred Industries</h4>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">$250,000 - $1,000,000</p>
                  </div>
                  
                  <div>
                    <h4 className="text-sm font-medium text-gray-500">Target Equity</h4>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h2 className="text-lg font-medium text-gray-900">Top Ranked Business Ideas</h2>
                <Link to="/ranked-ideas" className="text-sm text-primary-600 hover:text-primary-500">View all</Link>
              </div>
              ...
              <div className="divide-y divide-gray-200">
                <div className="px-6 py-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-900">New highly-rated idea available</p>
                      <p className="text-sm text-gray-500">HealthSync scored 92/100 in evaluation</p>
                    </div>
                ...
                <div className="px-6 py-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-gray-900">New message from entrepreneur</p>
                      <p className="text-sm text-gray-500">John responded to your inquiry about EcoDelivery</p>
                    </div>
                    <div className="ml-auto">
                      <ChevronRight className="h-5 w-5 text-gray-400" />
                    </div>
                ...
                <div className="px-6 py-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500">An entrepreneur wants to connect with you</p>
                    </div>
                    <div className="ml-auto">
                      <ChevronRight className="h-5 w-5 text-gray-400" />
                    </div>
